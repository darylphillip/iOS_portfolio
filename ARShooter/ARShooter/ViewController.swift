...
//  ARShooter
//
//  Created by Daryl Annen on 11/19/17.
...
class ViewController: UIViewController, SCNPhysicsContactDelegate {
    ...
    override func viewDidLoad() {
        ...
        let gestureRecogniser = UITapGestureRecognizer(target: self, action: #selector(handleTap(sender:)))
        self.sceneView.addGestureRecognizer(gestureRecogniser)
